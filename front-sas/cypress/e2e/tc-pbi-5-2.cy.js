describe("TC-CREATE-ANNOUNCEMENT-2: nomal - at boundary data", () => {
  ...
  it("should open add form and add a new announcment", () => {
    ...
    cy.get(".ann-title").type(
      "AAAAAAAA-BBBBBBBB-CCCCCCCC-DDDDDDDD-EEEEEEEE-FFFFFFFF-GGGGGGGG-HHHHHHHH-IIIIIIII-JJJJJJJJ-KKKKKKKK-LLLLLLLL-MMMMMMMM-NNNNNNNN-OOOOOOOO-PPPPPPPP-QQQQQQQQ-RRRRRRRR-SSSSSSSS-TTTTTTTT-UUUUUUUU-VVVVVVVV---"
    );
    cy.get(".ann-category").select("ฝึกงาน");
    const text = Cypress._.repeat(
      "กขฃคฅฆงจฉชซณญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรลวศษ-",
      150
    );
