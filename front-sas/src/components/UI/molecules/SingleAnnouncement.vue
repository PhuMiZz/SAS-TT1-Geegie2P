...
<template>
  <AnnouncementTemplate>
    ...
    <template #action>
      ...
      >
        <div
          class="bg-[#336699] w-20 text-white active:bg-[#23476b] hover:bg-[#23476b] font text-xl px-3 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
        >
          view
        </div>
      </button>
      <button class="ann-button" @click="toggleModal(announcementItem.id)">
        <div
          class="bg-[#EF4444] w-20 text-white active:bg-[#B91C1C] hover:bg-[#B91C1C] text-xl px-3 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
        >
          delete
        </div>
      </button>
