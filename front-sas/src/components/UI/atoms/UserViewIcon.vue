<template>
  ...
  >
    <path
      d="M22.675 27.025C21.575 27.35 20.275 27.5 18.75 27.5H11.25C9.72501 27.5 8.42501 27.35 7.32501 27.025C7.60001 23.775 10.9375 21.2125 15 21.2125C19.0625 21.2125 22.4 23.775 22.675 27.025Z"
      stroke-width="1.5"
    ...
    />
    <path
      d="M19.475 13.225C19.475 15.7 17.475 17.7125 15 17.7125C12.525 17.7125 10.525 15.7 10.525 13.225C10.525 10.75 12.525 8.75 15 8.75C17.475 8.75 19.475 10.75 19.475 13.225Z"
      stroke-width="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
    />
