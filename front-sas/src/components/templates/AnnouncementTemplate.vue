...
<template>
  <div
    ...
    :class="
      props.header
        ? 'text-[#737373]'
        : 'items-center bg-gray-100 w-full gap-1 md:justify-evenly md:h-24 my-2 rounded-xl'
    "
  >
    <div
    ...
    <div
      class="flex w-full md:w-1/4 justify-end md:justify-center pr-3 pb-3 md:p-0"
    >
