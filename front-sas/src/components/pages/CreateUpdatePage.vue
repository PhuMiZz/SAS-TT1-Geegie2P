...
const newAnnouncementDataJSON = computed(() => JSON.stringify(newAnnouncementData, null, 2));

const submitAnnouncement = async () =>{
    if (!newAnnouncementData.announcementTitle || !newAnnouncementData.announcementDescription || !newAnnouncementData.announcementCategory || !newAnnouncementData.publishDate || !newAnnouncementData.publishTime || !newAnnouncementData.closeDate || !newAnnouncementData.closeTime) {
      ...
      <template #detail>
        <TextDescription>
          <template #header>Category</template>
            <Dropdown v-model="newAnnouncementData.announcementCategory" :input="categories" class="ann-category" />
        </TextDescription>
        ...
        <TextDescription class="ann-display">
          ...
          <div class="flex gap-x-2">
            <input v-model="newAnnouncementData.display" type="checkbox" value="" name="display" id="display" />
